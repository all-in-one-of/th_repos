...
def McdStoryListEditorGUI():
    ...
    cmds.menuItem( label='Refresh contents', c = "McdRefreshStoryListEditor()")
    ...
    if dcNode != "":
        ...
        dStateSelMode = cmds.getAttr(dcNode + ".stateSel")
        
        cmds.rowColumnLayout(nc = 5, cw = [(1,100),(2,100),(3,100), (4,120), (5,140)])
        cmds.text(l = "Node Name:")
        try:
            cmds.textField("StoryNodeTF", ed = False, tx = dcNode)
        except:
            pass
        cmds.checkBox("storyItrp_cb", v = dInterruptible, l = "Interruptible", onc = "storyInterruptible(1)", ofc = "storyInterruptible(0)")
        cmds.checkBox("puresm_cb", v = dPureStateNode, l = "Pure State Node", onc = "storySM(1)", ofc = "storySM(0)")
        cmds.checkBox("stostsel_cb", v = dStateSelMode, l = "State Actions Select Mode", onc = "storyStSlMode(1)", ofc = "storyStSlMode(0)")
    ...
    cmds.tabLayout( tabs, edit = True, tabLabel=((child0, "Story List Setup"), (child1, "Instant Tips")))
