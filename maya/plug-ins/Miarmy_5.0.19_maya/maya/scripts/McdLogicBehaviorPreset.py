...
def McdPLB_collideAvoidSoundSimple():
    ...
    newDecision = "avoidSphereLfTurnRt"
    ...
    # ------------------------------------------
    newDecision = "avoidSphereRtTurnLf"
    activeAgentName = McdGetActiveAgentName()
    McdGetOrCreateDecisionGrp(activeAgentName, 1)
    McdCreateDecision(newDecision, activeAgentName)
    dcNode = ""
    ...
    if dcNodeTemp != [] and dcNodeTemp != None:
        ...
        cmds.setAttr(dcNode + ".outputValue["   + did + "]", 120)
    # ------------------------------------------
    newDecision = "avoidSphereFrtSlowDn"
    activeAgentName = McdGetActiveAgentName()
    McdGetOrCreateDecisionGrp(activeAgentName, 1)
    McdCreateDecision(newDecision, activeAgentName)
    dcNode = ""
...
def McdPLB_collideAvoidSound():
    ...
    # ------------------------------------------
    newDecision = "avoidSphereCloseLfTurnRt"
    activeAgentName = McdGetActiveAgentName()
    McdGetOrCreateDecisionGrp(activeAgentName, 1)
    McdCreateDecision(newDecision, activeAgentName)
    dcNode = ""
    ...
    # ------------------------------------------
    newDecision = "avoidSphereCloseRtTurnLf"
    activeAgentName = McdGetActiveAgentName()
    McdGetOrCreateDecisionGrp(activeAgentName, 1)
    McdCreateDecision(newDecision, activeAgentName)
    dcNode = ""
    ...
    if dcNodeTemp != [] and dcNodeTemp != None:
        ...
        cmds.setAttr(dcNode + ".outputValue["   + did + "]", 0.5)
    # ------------------------------------------
    newDecision = "avoidSphereCloseFrtSlowDn"
    activeAgentName = McdGetActiveAgentName()
    McdGetOrCreateDecisionGrp(activeAgentName, 1)
    McdCreateDecision(newDecision, activeAgentName)
    dcNode = ""
...
def McdPLB_FollowTerrain():
    ...
    newDecision = "GroundLUpTurnRPreset"
    activeAgentName = McdGetActiveAgentName()
    McdGetOrCreateDecisionGrp(activeAgentName, 1)
    McdCreateDecision(newDecision, activeAgentName)
    dcNodeTemp = cmds.ls(sl = True)
    ...
    newDecision = "GroundRUpTurnLPreset"
    activeAgentName = McdGetActiveAgentName()
    McdGetOrCreateDecisionGrp(activeAgentName, 1)
    McdCreateDecision(newDecision, activeAgentName)
    dcNodeTemp = cmds.ls(sl = True)
    ...
    newDecision = "GroundBUpTurnFPreset"
    activeAgentName = McdGetActiveAgentName()
    McdGetOrCreateDecisionGrp(activeAgentName, 1)
    McdCreateDecision(newDecision, activeAgentName)
    dcNodeTemp = cmds.ls(sl = True)
    ...
    newDecision = "GroundFUpTurnBPreset"
    activeAgentName = McdGetActiveAgentName()
    McdGetOrCreateDecisionGrp(activeAgentName, 1)
    McdCreateDecision(newDecision, activeAgentName)
    dcNodeTemp = cmds.ls(sl = True)
...
def McdSaveLogic():
    ...
    for i in range(len(selObjs)):
        if cmds.nodeType(selObjs[i]) == "McdDecision" or cmds.nodeType(selObjs[i]) == "transform":
...
def McdLoadLogic():
    ...
    allImpObjs = cmds.ls("MCDIMPORTLOGIC*")
