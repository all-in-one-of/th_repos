...
def McdMRSetupPreSetup():
    ...
    # execute
    melCmd = "McdARPPExportCmd -em 100;"
    mel.eval(melCmd)
    
    return globalNode
    
def McdMRSetupCurrentFrame_ByARMode(globalNode):
    ...
    melCmd = "McdARPPExportCmd -em 101;" # exporting and combining!
    mel.eval(melCmd)
...
def McdMRSetupCurrentFrame():
    ...
    duplicatedObject = RenderFBX.McdRandomizeTexturesDSO("mentalray", shaderPath)
    ...
    McdMRSetupCurrentFrame_ByARMode(globalNode)
