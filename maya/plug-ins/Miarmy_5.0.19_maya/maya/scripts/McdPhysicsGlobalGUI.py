...
def McdPhysicsGlobalGUI():
    ...
    try:
        dSCDist = cmds.getAttr(globalNode + ".clothscd")
    except:
        dSCDist = 0.1
    
    try:
        dCCTGravityFactor = cmds.getAttr(globalNode + ".cctGFactor")
    except:
        dCCTGravityFactor = 1
        
    try:
        dProjLiToln = cmds.getAttr(globalNode + ".projLiToln")
    except:
        dProjLiToln = 0.2
        
    dBuoIntensity = cmds.getAttr(globalNode + ".floatMaster[19]")
    dBuoDamping = cmds.getAttr(globalNode + ".floatMaster[20]")
    dBuoDOffset = cmds.getAttr(globalNode + ".floatMaster[21]")
    dAutoCCTOrt = cmds.getAttr(globalNode + ".boolMaster[14]")
 
    
    child0 = cmds.columnLayout(adj = True)
    
    cmds.rowColumnLayout(nc = 2, cw = [(1,350),(2,350)])
    
    cmds.columnLayout(adj = True)
    cmds.text(l = "Solver", fn = "smallBoldLabelFont", align = "left", h = 20)
    
    cmds.floatSliderGrp("pxgd_timed", l = "Each Step Time:", field = True, min = 0.1, max = 10.0, v = dStepTime,\
                      cc = 'setupSetpTime("'+globalNode+'")')
    
    cmds.intFieldGrp("pxgd_substp", l = "Sub Step:", v1 = dSubStep,\
                      cc = 'setSingleNumericAttrSliderGrpPxG(1, "pxgd_substp", "'+globalNode+'", "substep")')
    
    cmds.floatSliderGrp("pxgd_jplt", l = "Joint Fix Distance:", field = True, min = 0, max = 5, v = dProjLiToln,\
                      cc = 'setSingleNumericAttrSliderGrpPxG(2, "pxgd_jplt", "'+globalNode+'", "projLiToln")')
    ...
    cmds.text(l = "")
    cmds.text(l = "CCT (Character Controller)", fn = "smallBoldLabelFont", align = "left", h = 20)
    
    cmds.checkBoxGrp("pxcctao_cbg", l = "CCT Auto Orient", v1 = dAutoCCTOrt, \
                   cc = 'setSingleNumericAttrSliderGrpMiG(0, "pxcctao_cbg", "'+globalNode+'", "boolMaster[14]")')
    cmds.floatSliderGrp("pxgd_gvcct", l = "CCT Gravity Factor:", field = True, min = 0, max = 5, v = dCCTGravityFactor,\
                      cc = 'setSingleNumericAttrSliderGrpPxG(2, "pxgd_gvcct", "'+globalNode+'", "cctGFactor")')
    ...
    isLimit = cmds.getAttr(globalNode + ".boolMaster[11]")
    cmds.checkBoxGrp("pxgd_lmtspd", l = "Is Limit Max RBD Speed:", v1 = isLimit,\
                      cc = 'setSingleNumericAttrSliderGrpPxG(0, "pxgd_lmtspd", "'+globalNode+'", "boolMaster[11]")')
    
    dMaxRBDSpeed = cmds.getAttr(globalNode + ".floatMaster[2]")
    cmds.floatSliderGrp("pxgd_mxrbspd", l = "Maximum RBD Speed:", field = True, min = 0, max = 2000, v = dMaxRBDSpeed,\
                      cc = 'setSingleNumericAttrSliderGrpPxG(2, "pxgd_mxrbspd", "'+globalNode+'", "floatMaster[2]")')
        
    servoWeigthAcc = cmds.getAttr(globalNode + ".floatMaster[8]")
    cmds.floatSliderGrp("pxgd_svodist", l = "Servo Weight Accumulate:", field = True, min = 0, max = 10, v = servoWeigthAcc,\
                      cc = 'setSingleNumericAttrSliderGrpPxG(2, "pxgd_svodist", "'+globalNode+'", "floatMaster[8]")')
    
    cmds.text(l = "")
    cmds.text(l = "Buoyancy", fn = "smallBoldLabelFont", align = "left", h = 20)
    cmds.floatSliderGrp("pxbuoi_fsg", l = "Buoyant Force", field = True, min = 1, max = 10000, v = dBuoIntensity,\
                      cc = 'setSingleNumericAttrSliderGrpPxG(2, "pxbuoi_fsg", "'+globalNode+'", "floatMaster[19]")')
    cmds.floatSliderGrp("pxbuod_fsg", l = "Fluid Damping", field = True, min = 1, max = 10000, v = dBuoDamping,\
                      cc = 'setSingleNumericAttrSliderGrpPxG(2, "pxbuod_fsg", "'+globalNode+'", "floatMaster[20]")')
    cmds.floatSliderGrp("pxbuoo_fsg", l = "Draught Offset", field = True, min = -100, max = 100, v = dBuoDOffset,\
                      cc = 'setSingleNumericAttrSliderGrpPxG(2, "pxbuoo_fsg", "'+globalNode+'", "floatMaster[21]")')
    ...
    isClothCollideTerrain = cmds.getAttr(globalNode + ".boolMaster[22]")
    cmds.checkBoxGrp("pxcctr_cbg", l = "Collide Terrain:", v1 = isClothCollideTerrain,\
                      cc = 'setSingleNumericAttrSliderGrpPxG(0, "pxcctr_cbg", "'+globalNode+'", "boolMaster[22]")')
    ...
    #cmds.floatSliderGrp("pxcsss_fsg", l = "Stiffness Frequency:", field = True, min = 100, max = 500, v = dSStiff,\
    #                  cc = 'setSingleNumericAttrSliderGrpPxG(2, "pxcsss_fsg", "'+globalNode+'", "sStiff")')
    cmds.floatSliderGrp("pxcvss_stfdmp", l = "Damping Coefficient:", field = True, min = 0.0, max = 100.0, fmn = 0.01, v = dStiffDamp,\
                      cc = 'setSingleNumericAttrSliderGrpPxG(2, "pxcvss_stfdmp", "'+globalNode+'", "stiffDamping")')
    cmds.floatSliderGrp("pxcbs_fsg", l = "Bending Stiffness:", field = True, min = 0.0, max = 1, fmn = 0.01, v = dBendStiff,\
                      cc = 'setSingleNumericAttrSliderGrpPxG(2, "pxcbs_fsg", "'+globalNode+'", "bendStiff")')
    
    cmds.floatSliderGrp("pxcscd_fsg", l = "Self Collide Distance:", field = True, min = 0.0, max = 10, fmn = 0.01, v = dSCDist,\
                      cc = 'setSingleNumericAttrSliderGrpPxG(2, "pxcscd_fsg", "'+globalNode+'", "clothscd")')
