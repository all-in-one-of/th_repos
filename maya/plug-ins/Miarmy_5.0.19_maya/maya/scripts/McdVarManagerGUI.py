...
def McdVarManagerGUI():
    ...
    cmds.window(winName, title = "Agent/Host Maya Attribute Manager",rtf =True,menuBar=True, width=250)
    ...
    cmds.text(l = "Attribute Name", fn = "smallBoldLabelFont", align = "center")
    ...
    #separator(h = 10)
    cmds.text(l = "Instant Tips for Maya Attribute Manager", fn = "smallBoldLabelFont", align = "left")
    cmds.text(l = "* Setup Maya attribute on agent group nodes.", align = "left")
    cmds.button(l = "Check detailed help", h = 40)
    
    cmds.setParent( '..' )
    #----------------------------- End Instant Tips -------------------------------#
    
    cmds.tabLayout( tabs, edit=True,tabLabel=((child0, "Maya Attribute Setup"),\
                                            (child1, "Instant Tips")))
