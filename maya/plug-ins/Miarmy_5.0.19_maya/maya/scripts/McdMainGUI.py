...
def loadActionNodeUI():
    ...
    cmds.textScrollList('actionNodeTxSL',w=400,h=400,ams = 0,append=listAction,sc="""import McdMainGUI as ui \nui.selectItem('actionNodeTxSL')""")
    cmds.setParent(mainUI)
    cmds.separator(h=20,style="none",w=400)
#/////////////////////////////////////////////////////////
#
...
def loadDecisionNodeUI():
    ...
    cmds.textScrollList('desionNodeTxSL',w=400,h=250,ams = 0,append=listDecision,sc="""import McdMainGUI as ui \nui.selectItem('desionNodeTxSL')""")
    cmds.setParent(mainUI)
    cmds.separator(h=20,style="none",w=400)
#/////////////////////////////////////////////////////////
#
