...
def McdGroupVarEditorGUI():
    ...
    cmds.window(winName, title = "Attribute Connection Editor",rtf =True,menuBar=True, width=250)
    ...
    #separator(h = 10)
    cmds.text(l = "Instant Tips for Group Attribute Editor", fn = "smallBoldLabelFont", align = "left")
    cmds.text(l = "* Setup group attribute in channel box.", align = "left")
    cmds.button(l = "Check detailed help", h = 40)
    
    cmds.setParent( '..' )
    #----------------------------- End Instant Tips -------------------------------#
    
    cmds.tabLayout( tabs, edit=True,tabLabel=((child0, "Maya Attributes Setup"),\
                                            (child1, "Instant Tips")))
