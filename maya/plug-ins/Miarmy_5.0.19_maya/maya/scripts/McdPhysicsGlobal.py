...
def setSingleNumericAttrSliderGrpPxG(option, control, nodeName, attrName):
...
def setupSetpTime(globalNode):
    qValue = cmds.floatSliderGrp('pxgd_timed', q = True, v = True)
    qValue /= 10.0;
    cmds.setAttr(globalNode + ".stepTime", qValue)
