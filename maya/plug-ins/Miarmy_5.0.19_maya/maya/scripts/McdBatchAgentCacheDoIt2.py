...
def McdBatchAgentCacheDoIt2(folderStr, nameStr):
    # ---------------------------------------
    # place agent out
    ...
    McdMakeAgentCacheBatch2()
    
    
def McdMakeAgentCacheBatch2():

    performCachePreCheckBatch2()
...
def performCachePreCheckBatch2():
    # agent exist
