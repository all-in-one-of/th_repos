...
def McdInitShelf():
    ...
    Miarmy2014Up = False
    if int(mel.eval("getApplicationVersionAsFloat")) >= 2014:
        Miarmy2014Up = True
    ...
    if not xpm:
        try:
            ...
            imageLabelList.append("")
            commandList.append("import McdMainGUI as ui\nreload(ui)\nui.McdMainGUI()")
            ...
            if not Miarmy2011:
                ...
                imageList.append("")
            #
            annotationList.append("Detection Sphere Visible")
            labelList.append("SdVis")
            imageLabelList.append("")
            commandList.append("soundRangeSwitch()")
            imageList.append("soundVisible.png")
            #
            annotationList.append("Detection Frustum Visible")
            ...
            #
            annotationList.append("Move Tool")
            labelList.append("AgtVi")
            imageLabelList.append("")
            commandList.append("McdStateContextToolOn()")
